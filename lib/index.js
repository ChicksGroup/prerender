...
exports = module.exports = (
  ...
  // (same filters as /cache/list). At least one must be set (an empty filter would
  // match the whole cache — use /cache/flush for that). Eviction runs in the
  // BACKGROUND (a broad filter can match a lot) -> 202 + { matched, started }.
